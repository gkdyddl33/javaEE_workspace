...
// 목록 페이지 이므로 모든 레코드가 담겨 있는 걸 가져와야 한다.
...
<%Notice notice = list.get(i); // 각 칸에 들어간 vo 끄집어내기 %>
  <tr>
    <td>26</td>
    <td><%=board.getFilename() %></td>
    <td>
		<a href="/imageboard/detail.jsp?notice_id=<%=notice.getNotice_id()%>"><%=notice.getTitle()%></a>
	</td>
